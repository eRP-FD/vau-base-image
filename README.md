...
* Graphene docker image, build from this repository: https://github.ibmgcloud.net/eRp/vau-graphene-image
...
### 1. [Graphene](https://grapheneproject.io)
Graphene is installed form a debian package, which is build in https://github.ibmgcloud.net/eRp/vau-graphene-image
Additional packages for graphene are also installed (libprotobuf-c-dev, binutils, etc )

...
## Dependencies
* Haben Sie Zugang zu de.icr.io/erp_dev/ubuntu-jammy:*, oder laden Sie das ubuntu-jammy-Image und benenne es passend zum base image in der Docker-Datei.
...
IBM Cloud Logs ist ein zentralisiertes Log-Management-Tool, mit dem Teams in jeder Phase des Softwareentwicklungszyklus kontinuierliches Feedback erhalten.
